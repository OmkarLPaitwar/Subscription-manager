      ...
      <div className="main-content">
        ...
        <div style={S.topBar}>
          <div style={{ display:'flex', alignItems:'center', gap:12 }}>
            ...
            <h1 className="topbar-title" style={S.topTitle}>{title}</h1>
          </div>
        ...
        {/* Page Content */}
        <div className="dashboard-content-pad" style={S.content}>
...
const S = {
  ...
  topBar:       { background:'var(--bg2)', borderBottom:'1px solid var(--border)', padding:'0 20px', height:60, display:'flex', alignItems:'center', justifyContent:'space-between', position:'sticky', top:0, zIndex:40 },
